package uz.otamurod.qrcodescanner.cmp.ui.theme
...
val scanResultColor
    @Composable
    get() = if (isSystemInDarkTheme()) Color(0xFFFFE500)
    else Color(0xFF2293EF)

val copyFeedbackColor
    @Composable
    get() = if (isSystemInDarkTheme()) md_theme_light_onPrimary
